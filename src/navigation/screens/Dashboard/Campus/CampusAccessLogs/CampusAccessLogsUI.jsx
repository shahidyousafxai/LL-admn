...
const CampusAccessLogsUI = ({
  selectionIds,
  setSelectionIds,
  CampusAccessLogsColumnData,
  CampusAccessLogsColumnExtensionsData,
  CampusAccessLogsRowData,
  onChangeSearch,
  onCampusAccessLogsSearch,
  onClear,
  searchText,
  loading,
  networkError,
    ...
    <div className='main-container px-6 pt-3'>
      ...
      <div className='flex flex-row justify-between align-items-center py-3 gap-5'>
        ...
        <SearchBar
          ...
          onSearch={() => onCampusAccessLogsSearch()}
          onClear={() => onClear()}
      ...
      {loading ? (
        ...
        <CampusTable
          rows={CampusAccessLogsRowData}
          columns={CampusAccessLogsColumnData}
          tableColumnExtensions={CampusAccessLogsColumnExtensionsData}
...
export default CampusAccessLogsUI;
