...
// Local Imports
import UnitAccessLogsUI from "./UnitAccessLogsUI";
import {
	...
	return (
		<>
			<UnitAccessLogsUI
				...
				// Table Data
				UnitAccessLogsColumnData={UnitAccessLogsColumnData}
				UnitAccessLogsColumnExtensionsData={UnitAccessLogsColumnExtensionsData}
				UnitAccessLogsRowData={accessLogs}
				// Filter Modal States
				anchorEl={anchorEl}
				id={id}
				open={open}
				...
				onUnitAccessLogsSearch={onUnitSearch}
				onClear={onClear}
